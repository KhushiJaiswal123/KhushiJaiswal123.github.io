...
description: "An app for logging meals, tracking goals, and visualizing nutrition data through analytics"
...
::: {.column width="60%"}
BytesLog is a cross-platform mobile application I developed during my bachelor's project. The app empowers users to log their daily food intake, set personalized dietary goals, and monitor their progress. To enhance user engagement, the app features gamified achievements and badges, along with visually rich insights into calorie and macronutrient intake. (code is in a private github repo)
...
![](extras/ios.jpeg){width="150"}
:::
::: {.row height="40%"}
android

![](extras/anroid.jpeg){width="150"}
:::
:::
...
::: {.column width="25%"}
### Logging On
{{< video https://www.youtube.com/embed/XAVHsPY4vJw width="100%" height="400" >}}
:::

::: {.column width="25%"}
### Reward System
{{< video https://www.youtube.com/embed/IMDLzWf4rPQ width="100%" height="400" >}}
:::

::: {.column width="25%"}
### Food Entries
{{< video https://www.youtube.com/embed/zEK7vKsxvcg width="100%" height="400" >}}
:::

::: {.column width="25%"}
### Full Stats
{{< video https://www.youtube.com/embed/cPdq6kSsPQY width="100%" height="400" >}}
:::
:::
...
::: {.column width="25%"}
### Full App 
{{< video https://www.youtube.com/embed/YSQBFOvYDFQ width="100%" height="400" >}}
:::

:::


## Testing & Developer's Report 
Note: Code for this project is not publicly available :( 

::: columns
::: {.column width="50%"}
<iframe src="extras/bytesTestingReport.pdf" width="100%" height="600"></iframe>
:::
::: {.column width="50%"}
<iframe src="extras/bytesInstallationDocument.pdf" width="100%" height="600"></iframe>
:::
:::
